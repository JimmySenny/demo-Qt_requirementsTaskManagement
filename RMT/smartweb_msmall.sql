...
(
    ...
    `req_reqno` varchar(20) DEFAULT NULL COMMENT '需求提出编号',
    `req_dpm` varchar(20) DEFAULT NULL COMMENT '需求提出部门',
    `req_busiop` varchar(16) DEFAULT NULL COMMENT '需求经办人',
    `req_busioptel` varchar(16) DEFAULT NULL COMMENT '需求经办人联系电话',
    `req_inputdt` char(19) DEFAULT NULL COMMENT '需求提交时间',
    `req_expectdt` char(19) DEFAULT NULL COMMENT '需求期望交付时间',
    `req_busi` varchar(16) DEFAULT NULL COMMENT '需求所属业务产品',
    `req_level` char(1) DEFAULT NULL COMMENT '需求优先级',
    `req_type` char(2) DEFAULT NULL COMMENT '需求类型',
    `sys_attr` char(2) DEFAULT NULL COMMENT '需求属性',
    `req_name` varchar(128) DEFAULT NULL COMMENT '需求简述',
